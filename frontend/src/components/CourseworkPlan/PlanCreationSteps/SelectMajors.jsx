...
const SelectMajors = ({ onSelectionChange }) => {
  // Mock array of major courses with details
  const majorCourses = [
    {
      id: 1,
      course_code: "CS 191",
          ...
          >
            <CardContent className="p-0">
              <div className="flex items-start">
                <div className="w-2 h-full bg-red-500 flex-shrink-0"></div>
