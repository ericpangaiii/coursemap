...
const PlanCourse = ({ course, onDelete, currentStepType }) => {
  ...
  return (
    <div className="flex items-center justify-between w-full">
      <div 
        ...
        {...listeners}
        className={cn(
          "flex-1 px-2 py-1 rounded-md border border-gray-100 dark:border-gray-800 hover:border-blue-300 dark:hover:border-blue-700 hover:bg-blue-50 dark:hover:bg-blue-900/20 hover:shadow-md transition-all flex items-center gap-1.5",
          currentStepType === 'summary' ? 'cursor-default' : 'cursor-grab active:cursor-grabbing'
        )}
      >
